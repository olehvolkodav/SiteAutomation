(function($) {
    ...
    $('.one_page .fridge_menu .nav_scroll').onePageNav({
		...
		$('.witr_load').imagesLoaded(function() {
			...
			$('.imagess_id1').slick({	
				...
				new Swiper('.witr_active_id5', {
						...
						grabCursor: false,
						speed: 2000,
						direction: 'horizontal',slidesPerView: 3,spaceBetween: 20,freeMode: false,
						mousewheel: false,
						keyboard: true,
						loop: true,
						autoplay: {
